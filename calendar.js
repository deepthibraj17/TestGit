var cal = {
  ...
  list : function () {
    ...
    cal.data = localStorage.getItem("cal-" + cal.sMth + "-" + cal.sYear + "-" + cal.sTime + "-" + cal.eTime);
    if (cal.data==null) {
      localStorage.setItem("cal-" + cal.sMth + "-" + cal.sYear + "-" + cal.sTime + "-" + cal.eTime, "{}");
      cal.data = {};
    } else {
  ...
  show : function (el) {
    ...
    tForm += "Description <textarea id='evt-details' required>" + (cal.data[cal.sDay] ? cal.data[cal.sDay] : "") + "</textarea>";
    tForm += "Start Time <input type='time' id='start-time'/>";
    tForm += "   to   "
    tForm += "End Time <input type='time' id='end-time'/>";
    tForm += "<br>";
    tForm += "<input type='button' value='Close' onclick='cal.close()'/>";
    tForm += "<input type='button' value='Delete' onclick='cal.deleteEvent()'/>";
  ...
  save : function (evt) {
    ...
    localStorage.setItem("cal-" + cal.sMth + "-" + cal.sYear + "-" + cal.sTime + "-" + cal.eTime, JSON.stringify(cal.data));
    cal.list();
  },
